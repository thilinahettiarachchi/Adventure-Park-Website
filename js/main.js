 (function ($) {
    ...
    $('nav#dropdown').meanmenu({
        siteLogo: "<div class='mobile-menu-nav-back'><a href='index.html'><img src='img/logo/logo.png'/></a></div>"
    });
    ...
    $(window).on('load', function () {
        ...
        if (eventCounter.length) {
            eventCounter.countdown('2018/06/03', function(e) {
    ...
    if ($('#googleMap').length) {
        var initialize = function() {
                var mapOptions = {
                    zoom: 15,
                    scrollwheel: false,
                    center: new google.maps.LatLng(6.8593782, 79.9528634),
                    styles: [{
                        stylers: [{
                            saturation: -100
                        }]
